...
class New_Toplevel:
    ...
    def search(self):
        subprocess.call(" python fO6.py 1", shell=True)

    def department(self):
        subprocess.call(" python fO4.py 1", shell=True)
    ...
    def __init__(self, top=None):
        ...
        self.Button1_1.place(relx=0.67, rely=0.38, height=44, width=237)
        ...
        self.Button1_1.configure(command=self.department)

        self.Button1_1_1 = Button(top)
        self.Button1_1_1.place(relx=0.04, rely=0.38, height=44, width=237)
        ...
        self.Button1_1_1_1_1.configure(command=self.search)
