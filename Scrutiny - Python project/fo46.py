...
class New_Toplevel:
    ...
    def com(self):
        subprocess.call(" python fO76.py 1", shell=True)
    ...
    def gender(self):
        if (self.Entry1.get() == ""):
            ...
            for i in df.index:
                if g[i] == "Male" and d[i] == "ELECTRICAL":
                    a = a + 1
                elif g[i] == "MALE" and d[i] == "ELECTRICAL":
                    a = a + 1
                elif g[i] == "Female" and d[i] == "ELECTRICAL":
                    b = b + 1
                elif g[i] == "Female" and d[i] == "ELECTRICAL":
                    b = b + 1
    ...
    def university(self):
        ...
        if (self.Entry1.get() == ""):
            ...
            ss = 0
            for i in df.index:
                    if h[i] == "North Maharashtra" and d[i] == "ELECTRICAL":
                        n = n + 1
                    elif h[i] == "NORTH MAHARASHTRA" and d[i] == "ELECTRICAL":
                        n = n + 1
                    elif h[i] == "Amravati" and d[i] == "ELECTRICAL":
                        a = a + 1
                    elif h[i] == "AMRAVATI" and d[i] == "ELECTRICAL":
                        a = a + 1
                    elif h[i] == "Pune" and d[i] == "ELECTRICAL":
                        p = p + 1
                    elif h[i] == "PUNE" and d[i] == "ELECTRICAL":
                        p = p + 1
                    elif h[i] == "NA" and d[i] == "ELECTRICAL":
                        na = na + 1
                    elif h[i] == "na" and d[i] == "ELECTRICAL":
                        na = na + 1
                    elif h[i] == "S.R.T.M.U." and d[i] == "ELECTRICAL":
                        s = s + 1
                    elif h[i] == "Mumbai" and d[i] == "ELECTRICAL":
                        m = m + 1
                    elif h[i] == "MUMBAI" and d[i] == "ELECTRICAL":
                        m = m + 1
                    elif h[i] == "Nagpur" and d[i] == "ELECTRICAL":
                        nag = nag + 1
                    elif h[i] == "NAGPUR" and d[i] == "ELECTRICAL":
                        nag = nag + 1
                    elif h[i] == "B.A.M.U." and d[i] == "ELECTRICAL":
                        b = b + 1
                    elif h[i] == "Shivaji + Solapur" and d[i] == "ELECTRICAL":
                        ss = ss + 1
                    elif h[i] == "SHIVAJI + SOLAPUR" and d[i] == "ELECTRICAL":
                        ss = ss + 1
    ...
    def category(self):
        ...
        if (self.Entry1.get() == ""):
            ...
            for i in df.index:
                if c[i] == "Open" and d[i] == "ELECTRICAL":
                    n = n + 1
                elif c[i] == "OPEN" and d[i] == "ELECTRICAL":
                    n = n + 1
                elif c[i] == "DT/VJ" and d[i] == "ELECTRICAL":
                    a = a + 1
                elif c[i] == "SC" and d[i] == "ELECTRICAL":
                    p = p + 1
                elif c[i] == "OBC" and d[i] == "ELECTRICAL":
                    na = na + 1
                elif c[i] == "NT 2 (NT-C)" and d[i] == "ELECTRICAL":
                    s = s + 1
                elif c[i] == "NT 2(NT-C)" and d[i] == "ELECTRICAL":
                    s = s + 1
                elif c[i] == "NT 3 (NT-D)" and d[i] == "ELECTRICAL":
                    m = m + 1
                elif c[i] == "NT 3(NT-D)" and d[i] == "ELECTRICAL":
                    m = m + 1
                elif c[i] == "ST" and d[i] == "ELECTRICAL":
                    nag = nag + 1
                elif c[i] == "NA" and d[i] == "ELECTRICAL":
                    b = b + 1
                elif c[i] == "NT 1 (NT-B)" and d[i] == "ELECTRICAL":
                    ss = ss + 1
                elif c[i] == "NT 1(NT-B)" and d[i] == "ELECTRICAL":
                    ss = ss + 1
    ...
    def meritrank(self):
        ...
        if (self.Entry1.get() == ""):
            ...
            for i in df.index:
                ...
                if 0 < mk[i] <= 10000 and d[i] == "ELECTRICAL":
                    n = n + 1
                else:
                    if 10001 < mk[i] <= 20000 and d[i] == "ELECTRICAL":
                        a = a + 1
                    else:
                        if 20001 < mk[i] <= 30000 and d[i] == "ELECTRICAL":
                            p = p + 1
                        else:
                            if 30001 < mk[i] <= 40000 and d[i] == "ELECTRICAL":
                                na = na + 1
                            else:
                                if 40001 < mk[i] <= 50000 and d[i] == "ELECTRICAL":
                                    s = s + 1
                                else:
                                    if 50001 < mk[i] <= 60000 and d[i] == "ELECTRICAL":
                                        m = m + 1
                                    else:
                                        if 60001 < mk[i] <= 70000 and d[i] == "ELECTRICAL":
                                            nag = nag + 1
                                        else:
                                            if 70001 < mk[i] <= 80000 and d[i] == "ELECTRICAL":
                                                b = b + 1
                                            else:
                                                if 80001 < mk[i] and d[i] == "ELECTRICAL":
                                                    ss = ss + 1
    ...
    def merit12(self):
        if (self.Entry1.get() == ""):
            ...
            for i in df.index:
                ...
                if 40 < ma[i] <= 50 and d[i] == "ELECTRICAL":
                    n = n + 1
                else:
                    if 50.001 < ma[i] <= 60 and d[i] == "ELECTRICAL":
                        a = a + 1
                    else:
                        if 60.001 < ma[i] <= 70 and d[i] == "ELECTRICAL":
                            p = p + 1
                        else:
                            if 70.001 < ma[i] <= 80 and d[i] == "ELECTRICAL":
                                na = na + 1
                            else:
                                if 80.001 < ma[i] <= 90 and d[i] == "ELECTRICAL":
                                    s = s + 1
                                else:
                                    if 90.001 < ma[i] <= 100 and d[i] == "ELECTRICAL":
                                        m = m + 1
